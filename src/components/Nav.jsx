          ...
          <ThemeToggler>
            {({ theme, toggleTheme }) => (
              <span className="w-[30px]">
                <span id="goLight" className="hidden dark:block">
                  <button onClick={() => toggleTheme("light")} className="text-white">
                ...
                <span id="goDark" className="dark:hidden">
                  <button onClick={() => toggleTheme("dark")} className="text-gray-800">
