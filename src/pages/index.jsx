  ...
  <>
    ...
    <div className="mt-36 px-4 max-w-3xl mx-auto min-h-[calc(100vh-6rem)]">
      ...
      <main className="my-12 grid grid-cols-2 gap-4 auto-rows-fr">
        ...
        <div className="text-gray-800 border border-gray-200 dark:text-gray-400 dark:border-gray-600 rounded-lg p-4">
          <p>💻 Prev. Web-developer intern @ <a href="https://www.otys.nl" target="_blank" rel="noreferrer" className="underline font-medium text-gray-400 dark:text-gray-300">Otys</a></p>
        </div>
        <div className="text-gray-800 border border-gray-200 dark:text-gray-400 dark:border-gray-600 rounded-lg p-4">
          <p>🎓 Graduate Web designer @ <a href="https://www.glu.nl/opleiding/webdesign/" target="_blank" rel="noreferrer" className="underline font-medium text-gray-400 dark:text-gray-300">GLU</a></p>
        </div>
        <div className="text-gray-800 border border-gray-200 dark:text-gray-400 dark:border-gray-600 rounded-lg p-4">
          <p>👨‍💻 1st year Software Engineer @ <a href="https://www.hva.nl" target="_blank" rel="noreferrer" className="underline font-medium text-gray-400 dark:text-gray-300">HVA</a></p>
        </div>
      </main>
