  ...
  body.__html = body.__html.replaceAll("a href", 'a target="_blank" href');
    ...
    return (
      <>
        ...
        <hr />
        <a target="_blank" href={(github !== null && github !== '') ? github : ''} className={`${(github !== null && github !== '') ? '' : 'hidden'} bg-cyan-500 px-4 py-2 text-white rounded-lg hover:bg-cyan-600 dark:bg-cyan-600 dark:hover:bg-cyan-500 transition-colors no-underline inline-flex`}>
